...
<title>Online Tenant Applications | HousingHub</title>
...
<section class="hero z">
  <div class="hero-content">
    ...
    <div class="hero-stats">
      <div><div class="hstat-num">5 min</div><div class="hstat-label">Average Apply Time</div></div>
      <div><div class="hstat-num">Zero</div><div class="hstat-label">Paper Required</div></div>
      <div><div class="hstat-num">Instant</div><div class="hstat-label">Status Updates</div></div>
    </div>
  </div>
</section>
...
<section class="z reveal">
  ...
  <div class="steps-grid"><div class="step-card"><div class="step-num">01</div><div class="step-title">Find a Property</div><div class="step-desc">Browse listings and click "Apply Now" on any available property.</div></div><div class="step-card"><div class="step-num">02</div><div class="step-title">Fill the Form</div><div class="step-desc">Complete the digital application with your details and documents.</div></div><div class="step-card"><div class="step-num">03</div><div class="step-title">Submit &amp; Track</div><div class="step-desc">Submit in one click and track your status from your dashboard.</div></div><div class="step-card"><div class="step-num">04</div><div class="step-title">Get the Decision</div><div class="step-desc">Receive an instant notification when your application is reviewed.</div></div></div>
</section>
<section class="z reveal">
  ...
  <div class="features-grid"><div class="feat-card"><div class="feat-icon">&#128203;</div><h3 class="feat-title">Digital Application</h3><p class="feat-desc">Complete, structured form filled and submitted fully online.</p></div><div class="feat-card"><div class="feat-icon">&#128196;</div><h3 class="feat-title">Document Upload</h3><p class="feat-desc">Upload NIN, references, pay slips, and employment letters digitally.</p></div><div class="feat-card"><div class="feat-icon">&#128276;</div><h3 class="feat-title">Status Tracking</h3><p class="feat-desc">Track your application status in real time from your dashboard.</p></div><div class="feat-card"><div class="feat-icon">&#9989;</div><h3 class="feat-title">Landlord Dashboard</h3><p class="feat-desc">Landlords review all applications in one organised, searchable view.</p></div><div class="feat-card"><div class="feat-icon">&#128231;</div><h3 class="feat-title">Instant Notifications</h3><p class="feat-desc">Both parties notified at every stage of the application process.</p></div><div class="feat-card"><div class="feat-icon">&#128274;</div><h3 class="feat-title">Secure Storage</h3><p class="feat-desc">All application documents encrypted and stored securely.</p></div></div>
</section>
<section class="z reveal"><div class="stats-strip"><div><div class="stat-num">5 min</div><div class="stat-label">To Apply</div></div><div><div class="stat-num">Zero</div><div class="stat-label">Paper Needed</div></div><div><div class="stat-num">100%</div><div class="stat-label">Secure Storage</div></div><div><div class="stat-num">Instant</div><div class="stat-label">Notifications</div></div></div></section>
