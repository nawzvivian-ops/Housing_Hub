...
<title>Owner Portal & Reporting | HousingHub</title>
...
<section class="hero z">
  <div class="hero-content">
    ...
    <div class="hero-stats">
      <div><div class="hstat-num">Multi-Property</div><div class="hstat-label">Dashboard</div></div>
      <div><div class="hstat-num">Real-Time</div><div class="hstat-label">Data</div></div>
      <div><div class="hstat-num">Full</div><div class="hstat-label">Portfolio View</div></div>
    </div>
  </div>
</section>
<section class="z reveal">
  ...
  <div class="pain-grid">
    <div class="pain-col before"><div class="pain-col-label">&#128683; Before HousingHub</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Managing multiple properties using separate notebooks and spreadsheets</div><div class="pain-item"><span class="pain-icon">&#128683;</span>No consolidated view of which properties are performing well or poorly</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Calling individual tenants to check payment status every month</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Maintenance issues falling through the cracks across different properties</div><div class="pain-item"><span class="pain-icon">&#128683;</span>No way to generate a professional financial report for your portfolio</div></div>
    <div class="pain-col after"><div class="pain-col-label">&#10003; With HousingHub</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Single dashboard showing all properties, units, tenants, and income</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Live payment status for every tenant across every property you own</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Automatic monthly revenue reports per property and full portfolio</div><div class="pain-item"><span class="pain-icon">&#10004;</span>All maintenance jobs across all properties tracked in one unified view</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Export professional financial and occupancy reports with one click</div></div>
  </div>
</section>
<section class="z reveal">
...
<section class="z reveal">
  ...
  <div class="features-grid"><div class="feat-card"><div class="feat-icon">&#127968;</div><h3 class="feat-title">Multi-Property View</h3><p class="feat-desc">See all your properties, occupancy rates, and income in one place.</p></div><div class="feat-card"><div class="feat-icon">&#128200;</div><h3 class="feat-title">Revenue Dashboard</h3><p class="feat-desc">Track total rent collected, pending, and overdue across your portfolio.</p></div><div class="feat-card"><div class="feat-icon">&#128295;</div><h3 class="feat-title">Maintenance Overview</h3><p class="feat-desc">See all open and completed maintenance jobs across every property.</p></div><div class="feat-card"><div class="feat-icon">&#128196;</div><h3 class="feat-title">Financial Reports</h3><p class="feat-desc">Generate monthly and annual reports for each property or full portfolio.</p></div><div class="feat-card"><div class="feat-icon">&#128104;&#8205;&#127968;</div><h3 class="feat-title">Tenant Management</h3><p class="feat-desc">View all active tenants, lease dates, payment history, and contact info.</p></div><div class="feat-card"><div class="feat-icon">&#128229;</div><h3 class="feat-title">Export Everything</h3><p class="feat-desc">Download reports as PDF or CSV for accounting, tax, or investment review.</p></div></div>
</section>
<section class="z reveal"><div class="stats-strip"><div><div class="stat-num">Multi</div><div class="stat-label">Property Support</div></div><div><div class="stat-num">Real-Time</div><div class="stat-label">Dashboard</div></div><div><div class="stat-num">1-Click</div><div class="stat-label">Reports</div></div><div><div class="stat-num">Full</div><div class="stat-label">Portfolio View</div></div></div></section>
<section class="z reveal" style="padding-top:40px">
  <div class="cta-block">
    <h2>Take Full Control of <em>Your Portfolio.</em></h2>
    <p>The HousingHub Owner Portal gives you everything you need to manage, monitor, and grow your property business from one place.</p>
