...
<title>Smart Notification Center | HousingHub</title>
...
<section class="hero z">
  <div class="hero-content">
    ...
    <div class="hero-stats">
      <div><div class="hstat-num">Real-Time</div><div class="hstat-label">Alerts</div></div>
      <div><div class="hstat-num">100%</div><div class="hstat-label">Activity Covered</div></div>
      <div><div class="hstat-num">Zero</div><div class="hstat-label">Missed Updates</div></div>
    </div>
  </div>
</section>
<section class="z reveal">
  ...
  <div class="pain-grid">
    <div class="pain-col before"><div class="pain-col-label">&#128683; Before HousingHub</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Tenants forgetting to pay rent because there was no reminder system</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Landlords unaware of new maintenance requests until days later</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Lease expiry dates missed because no one was tracking them</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Important updates buried in WhatsApp groups with hundreds of messages</div><div class="pain-item"><span class="pain-icon">&#128683;</span>No central place to see a history of all platform activity</div></div>
    <div class="pain-col after"><div class="pain-col-label">&#10003; With HousingHub</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Automated rent reminders sent to tenants before every due date</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Instant push alerts for new maintenance requests, payments, and applications</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Lease expiry alerts triggered 30, 14, and 7 days in advance automatically</div><div class="pain-item"><span class="pain-icon">&#10004;</span>All notifications centralised in one in-platform inbox for easy review</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Full notification history so nothing important is ever missed or forgotten</div></div>
  </div>
</section>
<section class="z reveal">
  ...
  <div class="steps-grid"><div class="step-card"><div class="step-num">01</div><div class="step-title">Enable Notifications</div><div class="step-desc">Turn on your preferred notification channels from your account settings.</div></div><div class="step-card"><div class="step-num">02</div><div class="step-title">Activity Triggers</div><div class="step-desc">Every key platform action triggers the right notification automatically.</div></div><div class="step-card"><div class="step-num">03</div><div class="step-title">Receive Instantly</div><div class="step-desc">Get alerts via platform inbox, email, or SMS based on your preferences.</div></div><div class="step-card"><div class="step-num">04</div><div class="step-title">Review History</div><div class="step-desc">Access your full notification history anytime from your dashboard.</div></div></div>
</section>
<section class="z reveal">
  ...
  <div class="features-grid"><div class="feat-card"><div class="feat-icon">&#128276;</div><h3 class="feat-title">Rent Reminders</h3><p class="feat-desc">Automated tenant reminders before rent is due â€” reducing late payments.</p></div><div class="feat-card"><div class="feat-icon">&#128295;</div><h3 class="feat-title">Maintenance Alerts</h3><p class="feat-desc">Instant notifications for new, updated, and completed repair requests.</p></div><div class="feat-card"><div class="feat-icon">&#128196;</div><h3 class="feat-title">Lease Expiry Alerts</h3><p class="feat-desc">Automated warnings when any lease is approaching its end date.</p></div><div class="feat-card"><div class="feat-icon">&#128104;&#8205;&#127968;</div><h3 class="feat-title">Visitor Alerts</h3><p class="feat-desc">Real-time entry notifications when approved visitors arrive.</p></div><div class="feat-card"><div class="feat-icon">&#128231;</div><h3 class="feat-title">Multi-Channel Delivery</h3><p class="feat-desc">Receive alerts via in-app inbox, email, and SMS based on your settings.</p></div><div class="feat-card"><div class="feat-icon">&#128200;</div><h3 class="feat-title">Notification History</h3><p class="feat-desc">Full searchable log of all past notifications and platform activity.</p></div></div>
</section>
<section class="z reveal"><div class="stats-strip"><div><div class="stat-num">Real-Time</div><div class="stat-label">Delivery</div></div><div><div class="stat-num">100%</div><div class="stat-label">Coverage</div></div><div><div class="stat-num">Zero</div><div class="stat-label">Missed Alerts</div></div><div><div class="stat-num">Multi</div><div class="stat-label">Channel</div></div></div></section>
