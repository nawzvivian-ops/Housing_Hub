...
<title>Complaints & Feedback HUB | HousingHub</title>
...
<section class="hero z">
  <div class="hero-content">
    ...
    <div class="hero-stats">
      <div><div class="hstat-num">100%</div><div class="hstat-label">Complaints Tracked</div></div>
      <div><div class="hstat-num">Avg 48hrs</div><div class="hstat-label">Resolution Time</div></div>
      <div><div class="hstat-num">Anonymous</div><div class="hstat-label">Option Available</div></div>
    </div>
  </div>
</section>
<section class="z reveal">
  ...
  <div class="pain-grid">
    <div class="pain-col before"><div class="pain-col-label">&#128683; Before HousingHub</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Tenants complaining verbally with no record or follow-up mechanism</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Landlords dismissing complaints because there was no formal channel</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Issues escalating because they were never properly logged or addressed</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Tenants afraid to raise complaints for fear of retaliation</div><div class="pain-item"><span class="pain-icon">&#128683;</span>No way for management to spot recurring or systemic problems</div></div>
    <div class="pain-col after"><div class="pain-col-label">&#10003; With HousingHub</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Tenants log complaints formally on HousingHub with full details</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Option to submit anonymously for sensitive or personal issues</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Landlords and admins receive instant alerts and must acknowledge</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Every complaint tracked from submission to resolution with timestamps</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Management dashboard highlights unresolved and escalated complaints</div></div>
  </div>
</section>
<section class="z reveal">
  ...
  <div class="steps-grid"><div class="step-card"><div class="step-num">01</div><div class="step-title">Submit a Complaint</div><div class="step-desc">Tenant fills in the complaint form with details, category, and optional photos.</div></div><div class="step-card"><div class="step-num">02</div><div class="step-title">Landlord Alerted</div><div class="step-desc">Landlord or admin receives an instant notification and must acknowledge.</div></div><div class="step-card"><div class="step-num">03</div><div class="step-title">Response Logged</div><div class="step-desc">Landlord logs their response and proposed resolution on the platform.</div></div><div class="step-card"><div class="step-num">04</div><div class="step-title">Closed or Escalated</div><div class="step-desc">Complaint is marked resolved or escalated to HousingHub management.</div></div></div>
</section>
<section class="z reveal">
  ...
  <div class="features-grid"><div class="feat-card"><div class="feat-icon">&#128172;</div><h3 class="feat-title">Formal Complaint Form</h3><p class="feat-desc">Structured form capturing complaint type, details, severity, and attachments.</p></div><div class="feat-card"><div class="feat-icon">&#128373;</div><h3 class="feat-title">Anonymous Submission</h3><p class="feat-desc">Tenants can raise sensitive complaints without revealing their identity.</p></div><div class="feat-card"><div class="feat-icon">&#128276;</div><h3 class="feat-title">Instant Landlord Alert</h3><p class="feat-desc">Landlords notified immediately when a new complaint is filed.</p></div><div class="feat-card"><div class="feat-icon">&#128200;</div><h3 class="feat-title">Status Tracking</h3><p class="feat-desc">Both parties track complaint status from submission to resolution.</p></div><div class="feat-card"><div class="feat-icon">&#128680;</div><h3 class="feat-title">Escalation Path</h3><p class="feat-desc">Unresolved complaints auto-escalate to HousingHub admin after a set period.</p></div><div class="feat-card"><div class="feat-icon">&#128203;</div><h3 class="feat-title">Complaint History</h3><p class="feat-desc">Full record of all complaints per property available for audit and review.</p></div></div>
</section>
<section class="z reveal"><div class="stats-strip"><div><div class="stat-num">100%</div><div class="stat-label">Logged &amp; Tracked</div></div><div><div class="stat-num">Avg 48hr</div><div class="stat-label">Resolution</div></div><div><div class="stat-num">Anonymous</div><div class="stat-label">Option</div></div><div><div class="stat-num">Full</div><div class="stat-label">Audit Trail</div></div></div></section>
