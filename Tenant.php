...
<section class="hero z">
  <div class="hero-content">
    ...
    <div class="hero-stats">
      <div>
        <div class="hstat-num" data-count="1200" data-suffix="+">0</div>
        <div class="hstat-label">Listings Available</div>
      </div>
      <div>
        <div class="hstat-num" data-count="98" data-suffix="%">0</div>
        <div class="hstat-label">Tenant Satisfaction</div>
      </div>
      <div>
        <div class="hstat-num" data-count="5" data-suffix=" min">0</div>
        <div class="hstat-label">To Apply Online</div>
      </div>
    </div>
  </div>
</section>
...
<section class="z reveal">
  ...
  <div class="steps-grid">
    <div class="step-card"><div class="step-num">01</div><div class="step-title">Create Your Account</div><div class="step-desc">Register for free in under 2 minutes. No credit card or deposit required to browse.</div></div>
    <div class="step-card"><div class="step-num">02</div><div class="step-title">Browse &amp; Filter</div><div class="step-desc">Search properties by type, location, price, and size. Take virtual tours from anywhere.</div></div>
    <div class="step-card"><div class="step-num">03</div><div class="step-title">Apply Online</div><div class="step-desc">Submit your rental application digitally. Upload documents and get a response fast.</div></div>
    <div class="step-card"><div class="step-num">04</div><div class="step-title">Move In &amp; Manage</div><div class="step-desc">Pay rent, log maintenance, view your lease, and communicate with your landlord &mdash; all in one place.</div></div>
  </div>
</section>
...
<section class="z reveal" id="stats-section">
  <div class="stats-strip">
    ...
    <div>
      <div class="stat-num" data-count="5" data-suffix=" min">0</div>
      <div class="stat-label">Average Apply Time</div>
    </div>
    <div>
...
<section class="z reveal">
  ...
  <div class="testi-grid">
    <div class="testi-card"><div class="testi-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><p class="testi-text">"I found my apartment in Ntinda within 3 days of signing up. The virtual tour meant I knew exactly what I was getting before I even visited. No surprises."</p><div class="testi-author"><div class="testi-avatar">&#128105;</div><div><div class="testi-name">Nakato Sandra</div><div class="testi-role">Tenant &mdash; Ntinda, Kampala</div></div></div></div>
    <div class="testi-card"><div class="testi-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><p class="testi-text">"Paying rent used to mean lining up or calling the landlord. Now I just open the app, pay via MoMo in 30 seconds, and get my receipt immediately."</p><div class="testi-author"><div class="testi-avatar">&#128104;</div><div><div class="testi-name">Mugisha Collins</div><div class="testi-role">Tenant &mdash; Entebbe</div></div></div></div>
    <div class="testi-card"><div class="testi-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><p class="testi-text">"I reported a leaking tap and it was fixed within 48 hours. I could track the request the whole time. Best tenant experience I have had in Uganda."</p><div class="testi-author"><div class="testi-avatar">&#128105;</div><div><div class="testi-name">Apio Grace</div><div class="testi-role">Tenant &mdash; Jinja</div></div></div></div>
  </div>
</section>
...
<section class="quick-links z reveal">
  <div class="quick-container">
    ...
    <div class="quick-col"><h3>Use Cases</h3><a href="tenant.php">Tenants</a><a href="staff.php">Staff</a><a href="Visitor.php">Guests</a><a href="propertyowners.php">Property Owners</a><a href="broker.php">Broker-Free</a><a href="employment.php">Employment</a></div>
...
document.querySelectorAll('.dropdown').forEach(dd=>{
  ...
  if(!btn||!menu)return;
  btn.addEventListener('click',e=>{e.stopPropagation();const isOpen=menu.classList.contains('open');closeAllMenus();if(!isOpen){menu.classList.add('open');btn.classList.add('open')}});
...
document.querySelectorAll('a,button,.feat-card,.testi-card,.step-card').forEach(el=>{
...
// Trigger count-up when element scrolls into view (fires once)
const countObserver = new IntersectionObserver(entries => {
  entries.forEach(e => {
    if (e.isIntersecting) {
      countUp(e.target);
      countObserver.unobserve(e.target); // only once on scroll
    }
  });
}, { threshold: 0.3 });
...
// Re-trigger on click (tap to replay)
document.querySelectorAll('[data-count]').forEach(el => {
