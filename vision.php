...
@media(max-width:900px){header{padding:16px 24px;flex-wrap:wrap;gap:12px}nav{flex-wrap:wrap}.mission-section{grid-template-columns:1fr;gap:40px}.vision-statement,.pillars,.mission-standalone,.mission-section,.roadmap,.cta{padding:80px 6%}.quick-links{padding:60px 24px}.quick-container{grid-template-columns:1fr;gap:40px}}
@media(max-width:600px){.pillars-grid,.mission-cards,.mission-stats,.road-steps{grid-template-columns:1fr 1fr}}
#cur-dot{width:8px;height:8px;background:var(--gold);border-radius:50%;position:fixed;z-index:99999;pointer-events:none;transform:translate(-50%,-50%);mix-blend-mode:difference}
#cur-ring{width:20px;height:20px;border:1.5px solid rgba(200,164,60,.7);border-radius:50%;position:fixed;z-index:99998;pointer-events:none;transform:translate(-50%,-50%);transition:width .45s cubic-bezier(.23,1,.32,1),height .45s}
#cur-trail{width:30px;height:30px;border:1px solid rgba(200,164,60,.15);border-radius:50%;position:fixed;z-index:99997;pointer-events:none;transform:translate(-50%,-50%);transition:width .7s,height .7s}
body.cursor-hover #cur-dot{background:#fff}
...
<div class="about-hero z">
  ...
  <p class="vision-tagline" style="font-size:18px;font-weight:300;color:var(--muted);max-width:640px;margin:24px auto 0;line-height:1.8;font-style:italic;opacity:0;animation:fadeUp .9s ease .6s both">"To be Africa's most trusted and innovative property management platform."</p>
</div>
...
<section class="mission-section z reveal">
  <div class="mission-text">
    ...
    <p>To provide landlords, property managers, tenants, and brokers with an intelligent platform that reduces manual work, improves communication, ensures timely rent collection, and delivers full visibility over every property.</p>
  </div>
