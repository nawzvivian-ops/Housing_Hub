...
<title>Maintenance Management | HousingHub</title>
...
<section class="hero z">
  <div class="hero-content">
    ...
    <div class="hero-stats">
      <div><div class="hstat-num">3x Faster</div><div class="hstat-label">Issue Resolution</div></div>
      <div><div class="hstat-num">100%</div><div class="hstat-label">Requests Tracked</div></div>
      <div><div class="hstat-num">Zero</div><div class="hstat-label">Lost Reports</div></div>
    </div>
  </div>
</section>
<section class="z reveal">
  ...
  <div class="pain-grid">
    <div class="pain-col before"><div class="pain-col-label">&#128683; Before HousingHub</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Tenants calling or texting landlords about repairs with no follow-up</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Maintenance requests buried in WhatsApp messages and forgotten</div><div class="pain-item"><span class="pain-icon">&#128683;</span>No way for tenants to know if their request was received or acted upon</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Landlords with multiple properties losing track of pending repairs</div><div class="pain-item"><span class="pain-icon">&#128683;</span>No record of past maintenance work done on a property</div></div>
    <div class="pain-col after"><div class="pain-col-label">&#10003; With HousingHub</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Tenants log detailed requests with photos directly on the platform</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Landlords receive instant notifications and can assign jobs immediately</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Tenants track live status: Received, Assigned, In Progress, Done</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Full maintenance history per unit available for landlords and tenants</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Emergency requests are flagged and prioritised automatically</div></div>
  </div>
</section>
<section class="z reveal">
  ...
  <div class="steps-grid"><div class="step-card"><div class="step-num">01</div><div class="step-title">Log the Request</div><div class="step-desc">Tenant submits a detailed request with description, photos, and urgency.</div></div><div class="step-card"><div class="step-num">02</div><div class="step-title">Landlord Notified</div><div class="step-desc">Landlord receives an instant notification and assigns the job.</div></div><div class="step-card"><div class="step-num">03</div><div class="step-title">Work Begins</div><div class="step-desc">Tenant sees real-time status updates as the repair progresses.</div></div><div class="step-card"><div class="step-num">04</div><div class="step-title">Closed &amp; Recorded</div><div class="step-desc">Job is marked complete and logged permanently in maintenance history.</div></div></div>
</section>
<section class="z reveal">
  ...
  <div class="features-grid"><div class="feat-card"><div class="feat-icon">&#128295;</div><h3 class="feat-title">Request Logging</h3><p class="feat-desc">Tenants submit detailed requests with photos, descriptions, and urgency.</p></div><div class="feat-card"><div class="feat-icon">&#128276;</div><h3 class="feat-title">Instant Alerts</h3><p class="feat-desc">Landlords notified immediately when a new maintenance request is filed.</p></div><div class="feat-card"><div class="feat-icon">&#128200;</div><h3 class="feat-title">Live Status Tracking</h3><p class="feat-desc">Both parties see real-time progress from submission to completion.</p></div><div class="feat-card"><div class="feat-icon">&#128680;</div><h3 class="feat-title">Emergency Priority</h3><p class="feat-desc">Critical issues like floods or electrical faults get auto-prioritised.</p></div><div class="feat-card"><div class="feat-icon">&#128203;</div><h3 class="feat-title">Maintenance History</h3><p class="feat-desc">Full record of every repair job per property and per unit over time.</p></div><div class="feat-card"><div class="feat-icon">&#129520;</div><h3 class="feat-title">Technician Assignment</h3><p class="feat-desc">Assign technicians to jobs and track their progress on the platform.</p></div></div>
</section>
<section class="z reveal"><div class="stats-strip"><div><div class="stat-num">3x</div><div class="stat-label">Faster Repairs</div></div><div><div class="stat-num">100%</div><div class="stat-label">Jobs Tracked</div></div><div><div class="stat-num">Zero</div><div class="stat-label">Lost Requests</div></div><div><div class="stat-num">24/7</div><div class="stat-label">Reporting</div></div></div></section>
<section class="z reveal" style="padding-top:40px">
  <div class="cta-block">
    <h2>Stop Chasing <em>Repairs.</em></h2>
    <p>Give tenants a proper way to report issues and give yourself a clear system to manage every job from start to finish.</p>
