...
<title>Rent & Buy Reporting | HousingHub</title>
...
<section class="hero z">
  <div class="hero-content">
    ...
    <h1>Full Visibility of<br><em>Every</em><br><span class="stroke">Transaction.</span></h1>
    <p class="hero-sub">HousingHub's reporting engine gives landlords, property managers, and admins a complete real-time view of all rent payments, purchases, and lease activity across every property.</p>
    <div class="hero-btns">
      <a href="index.php" class="btn-primary">Get Started</a>
      <a href="properties.php" class="btn-secondary">Browse Properties</a>
    </div>
    <div class="hero-stats">
      <div><div class="hstat-num">100%</div><div class="hstat-label">Payment Transparency</div></div>
      <div><div class="hstat-num">Real-Time</div><div class="hstat-label">Reports</div></div>
      <div><div class="hstat-num">Zero</div><div class="hstat-label">Missing Records</div></div>
    </div>
  </div>
</section>
<section class="z reveal">
  ...
  <div class="pain-grid">
    <div class="pain-col before"><div class="pain-col-label">&#128683; Before HousingHub</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Tracking rent payments in exercise books or WhatsApp messages</div><div class="pain-item"><span class="pain-icon">&#128683;</span>No easy way to know which tenants have paid and which are overdue</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Generating monthly reports manually using pen and paper or Excel</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Landlords with multiple properties having no consolidated view</div><div class="pain-item"><span class="pain-icon">&#128683;</span>Payment disputes with no digital proof or audit trail</div></div>
    <div class="pain-col after"><div class="pain-col-label">&#10003; With HousingHub</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Automated rent payment reports generated the moment payment is made</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Colour-coded dashboard showing paid, pending, and overdue tenants</div><div class="pain-item"><span class="pain-icon">&#10004;</span>One-click monthly and annual reports for any property or portfolio</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Multi-property landlords see consolidated figures across all units</div><div class="pain-item"><span class="pain-icon">&#10004;</span>Every payment has a digital receipt, reference, and full audit trail</div></div>
  </div>
</section>
<section class="z reveal">
...
<section class="z reveal">
  ...
  <div class="features-grid"><div class="feat-card"><div class="feat-icon">&#128200;</div><h3 class="feat-title">Payment Dashboard</h3><p class="feat-desc">Live view of all payments across your entire property portfolio.</p></div><div class="feat-card"><div class="feat-icon">&#128229;</div><h3 class="feat-title">Export Reports</h3><p class="feat-desc">Download full reports as PDF or CSV for any property or period.</p></div><div class="feat-card"><div class="feat-icon">&#128680;</div><h3 class="feat-title">Overdue Alerts</h3><p class="feat-desc">Automatic flags and alerts for tenants who have not paid on time.</p></div><div class="feat-card"><div class="feat-icon">&#128176;</div><h3 class="feat-title">Revenue Tracking</h3><p class="feat-desc">Track total revenue, pending amounts, and trends month by month.</p></div><div class="feat-card"><div class="feat-icon">&#128196;</div><h3 class="feat-title">Digital Receipts</h3><p class="feat-desc">Every payment generates an instant, numbered digital receipt.</p></div><div class="feat-card"><div class="feat-icon">&#128274;</div><h3 class="feat-title">Audit Trail</h3><p class="feat-desc">Full payment history with timestamps kept for compliance and disputes.</p></div></div>
</section>
<section class="z reveal"><div class="stats-strip"><div><div class="stat-num">100%</div><div class="stat-label">Payment Visibility</div></div><div><div class="stat-num">Real-Time</div><div class="stat-label">Updates</div></div><div><div class="stat-num">Zero</div><div class="stat-label">Missing Records</div></div><div><div class="stat-num">1-Click</div><div class="stat-label">Export</div></div></div></section>
